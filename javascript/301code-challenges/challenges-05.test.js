...
const addValues = (arr) => {
  // Solution code here...
  let reduceCallback = (previousNumber, currentNumber) => previousNumber + currentNumber;
...
const addPurchases = (arr) => {
  // Solution code here...
  let reduceCallback = (accumulator, itemObject) => accumulator + itemObject.purchasePrice;
  return arr.reduce(reduceCallback, 0);
};
...
const countNumberOfElements = (arr) => {
  // Solution code here...
  let arrLength = arr.reduce(function (acc){
    acc = acc + 1;
    return acc;
  }, 0);
  return arrLength;
...
const returnNames = (arr) => {
  // Solution code here...
  let listOfStarNames = [];
  arr.reduce((acc, value) => (listOfStarNames.push(value.name)), []);
  return listOfStarNames;
};
...
const reversedString = (str) => {
  // Solution code here...
  let arr = str.split('');
  let backwards = arr.reduce((acc, val) => {
    return val + acc;
  }, '');
  return backwards;
};
